...
print("Player 1 is: " + player1.name + " with colour: " + player1.colour)
print("Player 2 is: " + player2.name + " with colour: " + player2.colour)
while True:
...
if (currentPlayer == 1):
	print("The winner is Player 1: " + player1.name + " with colour " + player1.colour)
else:
	print("The winner is Player 2: " + player2.name + " with colour " + player2.colour)
